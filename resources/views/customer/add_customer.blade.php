<x-app-layout>
	...
	<x-slot name="content">
		<form method="post" id="create_customer" class="customer_add" action="{{route('customer.store')}}}">
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom copy-input required"
											name="customer_town" id="customer_town" placeholder="Town/City"
											tabindex="5">
									</div>
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								...
								<div class="col-xs-6">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom required"
											name="customer_town_ship" id="customer_town_ship" placeholder="Town/City"
											tabindex="12">
									</div>
									<div class="form-group no-margin-bottom">
